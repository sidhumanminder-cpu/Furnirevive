...
function isGurgaonSlug(slug: string): boolean {
  return slug.includes("gurgaon") || slug.includes("sohna") || (slug.includes("dlf") && !slug.includes("noida"));
}

function isNoidaSlug(slug: string): boolean {
  return slug.includes("noida") || slug.includes("greater-noida");
}
...
function isSouthDelhiSlug(slug: string): boolean {
  return slug.includes("south-delhi") || slug.includes("hauz-khas") || slug.includes("safdarjung") || slug.includes("panchsheel") || slug.includes("gulmohar") || slug.includes("lajpat") || slug.includes("vasant-kunj") || slug.includes("greater-kailash") || slug.includes("defence-colony") || slug.includes("green-park") || slug.includes("friends-colony") || slug.includes("saket") || slug.includes("east-of-kailash");
}
