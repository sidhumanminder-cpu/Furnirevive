...
export const sofaRepairDelhi: SeoPageData = {
  ...
  metaDescription:
    "Sofa repair near me in Delhi from ₹500. Same-day home service for recliner, leather, wooden & upholstery repair near me. All Delhi areas. Free inspection. 6-month warranty. Call +91 92179 99355.",
  quickAnswer:
  ...
  heroSubtitle:
    "Delhi's most trusted sofa repair service — 500+ sofas repaired in Delhi, at your doorstep in 4 hours or less. Starting ₹500. Free inspection. 6-month warranty. South Delhi, Dwarka, Rohini, Vasant Kunj & 50+ areas.",
  showcaseImage: {
  ...
  intro: [
    ...
    "What makes us different from the local carpenter or roadside upholsterer? Transparent written pricing before work starts. A 6-month warranty card on every job. Professional tools — not hammers. 32–40 density foam — not cheap substitutes. And a documented repair process with post-job quality inspection. Read our <a href=\"/blog/sofa-repair-cost-delhi\">sofa repair cost guide</a> or <a href=\"/blog/sofa-repair-vs-upholstery-delhi\">sofa repair vs full upholstery guide</a> to understand your options before booking.",
  ...
  priceTable: {
    heading: "Sofa Repair Cost in Delhi — April 2026 Price Guide",
    rows: [
      { service: "Single Cushion Foam Replacement", price: "₹1,200–₹2,500" },
      { service: "Full 3-Seater Foam Set", price: "₹3,500–₹8,000" },
      { service: "Spring / Zigzag Wire Repair", price: "₹800–₹2,000" },
      { service: "Fabric Upholstery (per seat)", price: "₹2,000–₹4,500" },
      { service: "Leather / Rexine Upholstery (per seat)", price: "₹3,000–₹6,000" },
      { service: "Frame / Joint Repair", price: "₹1,500–₹4,000" },
      { service: "Recliner Mechanism Repair", price: "₹1,500–₹3,500" },
      { service: "Recliner Motor Replacement", price: "₹2,500–₹6,000" },
  ...
  relatedPages: relatedExcluding("sofa-repair-delhi"),
  relatedPageGroups: [
    {
...
export const chairRepairDelhi: SeoPageData = {
  ...
  title: "Chair Repair in Delhi NCR | Office, Gaming Chair Hydraulic & Wheel Fix at Home | FurniRevive",
  metaDescription:
    "Chair repair in Delhi from ₹599. Office chair hydraulic (gas lift), wheel/caster replacement, gaming chair repair, wooden & dining chair fix — same-day doorstep service across Delhi NCR. Call +91 92179 99355 or WhatsApp for free quote. 6-month warranty.",
  quickAnswer:
  ...
  priceTable: {
    heading: "Chair Repair Cost in Delhi — April 2026 Price Guide",
    rows: [
      { service: "Gas Lift / Hydraulic Replacement", price: "₹800–₹1,500" },
      { service: "Caster Wheel Set (5 wheels)", price: "₹400–₹1,000" },
      { service: "Chair Base Replacement", price: "₹500–₹1,500" },
      { service: "Chair Re-Upholstery", price: "₹1,000–₹3,000" },
      { service: "Wooden Joint Repair", price: "₹599–₹1,500" },
      { service: "Armrest Repair / Replacement", price: "₹500–₹1,200" },
      { service: "Dining Chair Re-Upholstery", price: "₹1,000–₹2,500" },
      { service: "Doorstep Visit Charge", price: "₹99–₹199" },
    ],
  },
  repairSigns: [
...
export const furnitureRepairDelhi: SeoPageData = {
  ...
  title: "Furniture Repair Delhi | All Types Fixed ₹599 Onwards | Same Day | FurniRevive",
  metaDescription:
    "Delhi's #1 furniture repair service starting ₹599. Sofa, bed, chair, table & wardrobe repaired at your doorstep. Same-day service across South Delhi, Dwarka, Rohini. 6-month warranty. Book now!",
  quickAnswer:
    "Furniture repair in Delhi starts at ₹599. FurniRevive repairs sofas, beds, chairs, tables, and wardrobes at your doorstep with same-day service across all Delhi localities. Free inspection, transparent pricing, and 6-month warranty on every job.",
  h1: "Furniture Repair in Delhi — All Types, All Localities",
  heroSubtitle:
    "Complete furniture repair solutions for your Delhi home and office. Sofas, beds, chairs, tables, wardrobes — everything repaired at your doorstep across South Delhi, Dwarka, Rohini, Preet Vihar, and all areas.",
  nearMeSection: {
  ...
  priceTable: {
    heading: "Furniture Repair Cost in Delhi — 2025 Price Guide",
    rows: [
      { service: "Chair Repair", price: "₹599–₹3,000" },
      { service: "Sofa Repair", price: "₹999–₹25,000" },
      { service: "Bed Frame Repair", price: "₹1,199–₹5,000" },
      { service: "Wardrobe Repair", price: "₹799–₹4,000" },
      { service: "Dining Table Repair", price: "₹999–₹3,500" },
      { service: "Furniture Polish", price: "₹799–₹20,000" },
    ],
  },
  repairSigns: [
  ...
  keywords: ["furniture repair delhi", "furniture repair near me", "furniture repair delhi ncr", "best furniture repair service delhi", "furniture repair south delhi", "furniture repair dwarka"],
};
...
export const carpenterHomeServiceDelhi: SeoPageData = {
  ...
  title: "Carpenter Near Me Delhi | Same-Day Home Service ₹499 | Verified | FurniRevive",
  metaDescription:
    "Need a carpenter near me in Delhi? FurniRevive sends verified carpenters to your doorstep for furniture repair, assembly & custom work starting ₹499. Same-day service. No hidden charges. Book now!",
  quickAnswer:
  ...
  priceTable: {
    heading: "Carpenter Charges in Delhi — 2025 Price Guide",
    rows: [
      { service: "Basic Carpentry (hinges/screws)", price: "₹499–₹999" },
      { service: "Furniture Assembly", price: "₹500–₹2,000" },
      { service: "Door Repair & Adjustment", price: "₹500–₹1,500" },
      { service: "Kitchen Cabinet Repair", price: "₹800–₹3,000" },
      { service: "Wardrobe Repair", price: "₹799–₹4,000" },
      { service: "Custom Shelving", price: "₹1,500–₹6,000" },
    ],
  },
  relatedPages: relatedExcluding("carpenter-home-service-delhi"),
  keywords: ["carpenter near me", "carpenter near me delhi", "carpenter home service delhi", "carpenter charges delhi", "furniture carpenter delhi", "IKEA assembly delhi"],
};
...
export const sofaUpholsteryDelhi: SeoPageData = {
  ...
  title: "Sofa Upholstery Delhi | 500+ Fabrics, Re-Upholstery ₹3999 | FurniRevive",
  metaDescription:
    "Expert sofa upholstery in Delhi NCR starting ₹3,999. Choose from 500+ fabrics for re-upholstery, leather restoration & cushion replacement. Transform your sofa. 6-month warranty. Book now!",
  quickAnswer:
  ...
  keywords: ["sofa upholstery delhi", "sofa re-upholstery near me", "sofa fabric change delhi", "sofa upholstery cost delhi"],
};
