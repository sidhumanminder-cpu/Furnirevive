...
export const officeChairRepairDelhi: SeoPageData = {
  ...
  priceTable: {
    heading: "Office Chair Repair Cost in Delhi — 2025 Price Guide (Factors: chair brand, part availability, damage type)",
    rows: [
      { service: "Gas Lift Cylinder Replacement (Class 3)", price: "₹800–₹1,000" },
      { service: "Gas Lift Replacement (Class 4 Heavy Duty)", price: "₹1,200–₹1,500" },
      { service: "Wheel/Castor Set Replacement (5 wheels)", price: "₹500–₹800" },
      { service: "Armrest Pad Replacement (per arm)", price: "₹600–₹1,200" },
      { service: "Seat Foam Re-stuffing", price: "₹1,000–₹2,500" },
      { service: "Mesh Back/Seat Replacement", price: "₹1,500–₹3,000" },
      { service: "Tilt Mechanism Repair", price: "₹800–₹2,000" },
      { service: "Full Chair Overhaul (all parts)", price: "₹3,000–₹5,000" },
    ],
  },
  localAreasSection: {
    heading: "Office Chair Repair Near Me — Areas Covered in Delhi NCR",
    areas: ["South Delhi", "Dwarka", "Rohini", "Connaught Place", "Nehru Place", "Noida Sector 62", "Gurgaon Cyber City", "Okhla", "Lajpat Nagar", "Greater Kailash", "Janakpuri", "Preet Vihar", "Pitampura", "Karol Bagh", "Faridabad", "Ghaziabad"],
  },
  trustSignals: ["Same-day doorstep service Delhi NCR", "All brands: Featherlite, Godrej, IKEA, Green Soul, Herman Miller", "Bulk corporate rates for 10+ chairs", "30–60 min repair time", "6-month warranty on all parts"],
  contentSections: [
    {
  ...
  faqs: [
    ...
    { question: "How do I find office chair repair near me in Delhi?", answer: "FurniRevive is Delhi NCR's most-booked office chair repair service. We offer doorstep repair near you across South Delhi, Dwarka, Rohini, Noida, Gurgaon, and all NCR areas. Call +91 92179 99355 or WhatsApp a photo for same-day service." },
    { question: "Is office chair repair available near me same day in Delhi?", answer: "Yes. Office chair repair near me same day is available across Delhi NCR when booked before 1 PM. Our technicians carry gas lift cylinders, wheel sets, armrest pads, and foam for immediate on-site repair. No need to take your chair anywhere." },
    { question: "What is included in the office chair repair price?", answer: "The price includes: doorstep visit, diagnosis, the specific part replaced (gas lift, wheels, armrest pad, foam), and labour. No hidden charges. A 6-month warranty is included on all replaced parts." },
    { question: "What is NOT included in the repair price?", answer: "Specialty parts for rare imported models (e.g. specific Herman Miller or Steelcase components) may have additional sourcing costs if not in our standard inventory. This is always disclosed upfront before work begins." },
    { question: "Can you repair office chair wheels without moving the chair?", answer: "Yes. Wheel replacement is done in 10 minutes with the chair in place at your home or office. No transport required. We carry PU wheel sets for all standard 5-castor bases." },
  ],
