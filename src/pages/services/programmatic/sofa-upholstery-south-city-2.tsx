...
const LOCALITY = "south-city-2" as const;
...
if (!auditResult.valid) {
  if (import.meta.env.DEV) {
    console.warn(`[SEO Audit] sofa-upholstery-south-city-2 — ${auditResult.errors.length} error(s):`, auditResult.errors);
  } else {
    console.error(`[SEO Audit] sofa-upholstery-south-city-2 — audit failed:`, auditResult.errors);
  }
}
const pageData = {
...
export default function SofaUpholsterySouthCity2() {
