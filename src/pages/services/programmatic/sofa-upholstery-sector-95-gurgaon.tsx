...
if (!auditResult.valid) {
  if (import.meta.env.DEV) {
    console.warn(`[SEO Audit] sofa-upholstery-sector-95-gurgaon — ${auditResult.errors.length} error(s):`, auditResult.errors);
  } else {
    console.error(`[SEO Audit] sofa-upholstery-sector-95-gurgaon — audit failed:`, auditResult.errors);
  }
}
const pageData = {
...
export default function SofaUpholsterySector95Gurgaon() {
