...
const LOCALITY = "golf-course-extension" as const;
...
if (!auditResult.valid) {
  if (import.meta.env.DEV) {
    console.warn(`[SEO Audit] sofa-upholstery-golf-course-extension — ${auditResult.errors.length} error(s):`, auditResult.errors);
  } else {
    console.error(`[SEO Audit] sofa-upholstery-golf-course-extension — audit failed:`, auditResult.errors);
  }
}
const pageData = {
...
export default function SofaUpholsteryGolfCourseExtension() {
