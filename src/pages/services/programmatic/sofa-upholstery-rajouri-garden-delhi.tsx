...
const LOCALITY = "rajouri-garden" as const;
...
if (!auditResult.valid) {
  if (import.meta.env.DEV) {
    console.warn(`[SEO Audit] sofa-upholstery-rajouri-garden-delhi — ${auditResult.errors.length} error(s):`, auditResult.errors);
  } else {
    console.error(`[SEO Audit] sofa-upholstery-rajouri-garden-delhi — audit failed:`, auditResult.errors);
  }
}
const pageData = {
...
export default function SofaUpholsteryRajouriGardenDelhi() {
